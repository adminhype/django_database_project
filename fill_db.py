...
customer1 = Customer.objects.create(first_name="John", last_name="Doe",
                                    newsletter=True, email="john.doe@example.com", account=100.0)
customer2 = Customer.objects.create(first_name="Jane", last_name="Smith",
                                    newsletter=False, email="jane.smith@example.com", account=200.0)
customer3 = Customer.objects.create(first_name="Alice", last_name="Johnson",
                                    newsletter=True, email="alice.johnson@example.com", account=300.0)
...
bill4 = Bill.objects.create(total_amount=200.0, is_paid=True)
bill5 = Bill.objects.create(total_amount=250.0, is_paid=False)
